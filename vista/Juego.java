...
public class Juego extends JFrame implements Observer {
	...
	private class Controler implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			else if (e.getSource().equals(getBtnCasino())) {
				tama.iniciarCasino();
			}
		}
	}
	...
	public void animar() {
		...
		if (getBtnCasino().getBackground().equals(new Color(0, 255, 0))) {
			getBtnCasino().setBackground(new Color(255, 0, 0));
		}else {
			getBtnCasino().setBackground(new Color(0, 255, 0));
		}
	}
	private JButton getBtnCasino() {
		if (btnCasino == null) {
			btnCasino = new JButton("Casino");
			btnCasino.setBackground(new Color(0, 255, 0));
			btnCasino.addActionListener(getControler());
		}
		return btnCasino;
	}
}